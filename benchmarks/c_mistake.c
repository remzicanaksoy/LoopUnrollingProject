...
/*
  Purpose:
    ...
    C_MISTAKE3 computes the sum of 100 random numbers but doesn't
    get a value close to 50.
...
/*
  Purpose:
    ...
    C_MISTAKE4 computes the sum of 100 random numbers but doesn't
    get a value close to 50.
...
/*
  Purpose:
    ...
    C_MISTAKE5 computes the sum of 100 random numbers but doesn't
    get a value close to 50.
